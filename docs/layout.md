...
ALL NATION CHURCH.1 provides a set of options to apply to your main layout. Each one of these classes can be added to the body tag to get the desired goal.
...
ALL NATION CHURCH.1 provides a dark mode option. You can add in body tag:
...
ALL NATION CHURCH.1 provides a set of color variations to apply to your sidebar (light & dark) & navbar. You can combine any available color with these class prefixes:
