  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>View Church Member</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
              <li class="breadcrumb-item active">View Church Member</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card card-dark">
              <div class="card-header">
                <h3 class="card-title">CHURCH MEMBER DETAILS</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
<nav class="navbar navbar-light bg-light">
  <div class="container-fluid">
   <!-- <div class="container  "> -->
<form class="form-inline" method="post" action="../view_believer/generate_pdf2.php">
...
<div class="row">
    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <?php
            if(!empty($believer)){ $count = 0;
                foreach($believer as $user){
                   if($user["BELIEVER"]=="Church_Member"){$count++;
            ?>
            <tr>
           ...
           <?php   echo '<a href=\church/pages/view_believer/edit.php?id=' .
                                    $user['id'] .
                                    '>
          <CENTER><button type="button" class="btn btn-sm btn-warning customerViewModel " name="ID"  id=' .
            ...
            EDIT
                  ...
                  <td>
               <?php   echo ' <a href=\church/pages/view_believer/delete.php?id=' .
                                    $user['id'] .
                                    '>
