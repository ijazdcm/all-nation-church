...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-light-primary elevation-4">
      <!-- Brand Logo -->
      <a href="../MainDashboard.php" class="brand-link">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="..\add_believer\add_believer.php" class="nav-link">
            ...
            <li class="nav-item">
              <a href="..\viewBelieversCrud\index.php" class="nav-link">
            ...
            <li class="nav-item">
              <a href="..\viewChurchBelievercard\index.php" class="nav-link">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="..\Reportss\Report.php" class="nav-link active">
                    <i class="fas fa-filter nav-icon"></i>
                    <p>REPORT FILTER</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="..\Reportss\re.php" class="nav-link">
